...
- [Gaussian]{style="font-size: 50px;"}
    ...
    - [Response Variable is Gaussian (Continuous Any Real Value)]{style="font-size: 40px;" }
...
- [Poisson]{style="font-size: 50px;"}
    ...
    - [Response Variable is Poisson (Counts per unit time or space)]{style="font-size: 40px;" }
...
- [Binomial]{style="font-size: 50px;"}
    ...
    - [Response Variable is Binomial (two or more possible values)]{style="font-size: 40px;" }
